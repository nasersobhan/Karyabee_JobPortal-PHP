    ...
    b.fn.uploadFile = function(t) {
        ...
        function l(H, B, u) {
            for (var C = 0; C < u.length; C++) {
                ...
                E.filename.html(G);
                var v = b("<form style='display:none; position:absolute;left: 150px;' class='" + B.formGroup + "' method='" + H.method + "' action='" + H.url + "' enctype='" + H.enctype + "'></form>");
                v.appendTo("body");
                var x = [];
                x.push(u[C].name);
                n(v, D, E, x, B);
        ...
        function p(v, u) {
            ...
            this.filename = b("<div class='upload-filename' style='display:none'></div>").appendTo(this.statusbar);
